...
<html>
  <head><!-- Title and style-formatting -->
    ...
    <style>
      h1 { text-align: center; text-shadow: 2px 2px 3px #666666; color: blue; }
      h2 { text-align: center; text-shadow: 2px 2px 3px #666666; color: blue; }
      body { text-align: center; background-color: #5EBED8; }
      form { text-align: center; }
      legend { font-weight: bold; }
      fieldset { display: inline-block; }
      textarea { background-color: #F9F6F0; }
      table { margin-left: auto; margin-right: auto; }
      td { background-color: #33CAFF; text-align:center; }
    </style>
  </head>
  <body><!-- Form and input-handling using PHP -->
    <h1> Movie Database Query Form </h1>
    Please enter an SQL query in the box below:
